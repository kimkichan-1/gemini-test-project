...
export const player = (() => {
    class Player {
        constructor(params) {
            ...
            // === 쿨타임 관련 변수 추가 ===
            this.rollCooldown_ = 1.0;    // 쿨타임(초)
            this.rollCooldownTimer_ = 0; // 남은 쿨타임
            ...
            switch (event.code) {
                ...
                case 'KeyL':
                    ...
                    if (
                        ...
                        this.rollCooldownTimer_ <= 0 // 쿨타임이 끝났을 때만 롤 가능
                    ) {
                        ...
                        if (moveDir.lengthSq() === 0) {
                            // 이동 입력이 없으면 캐릭터가 바라보는 방향(전방)으로 롤
        ...
        LoadModel_() {
            ...
            loader.load('Zombie_Male.gltf', (gltf) => {
